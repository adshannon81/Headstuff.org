    ...
    tinymce.PluginManager.add( 'fb_test', function( editor, url ) {
        ...
        editor.addButton( 'fb_test_button_key', {
            ...
            values: [
                ...
                {text: 'Youtube video', classes: 'td_tinymce_dropdown_title'},
                {text: '[td_video_youtube]', onclick : function() {
                    tinymce.activeEditor.execCommand('mceInsertContent', false, '[td_video_youtube yt="" auto_play="0" /]' + tinyMCE.activeEditor.selection.getContent());
                }},
                {text: '[td_video_vimeo]', onclick : function() {
                    tinymce.activeEditor.execCommand('mceInsertContent', false, '[td_video_vimeo v="" auto_play="0" /]' + tinyMCE.activeEditor.selection.getContent());
                }},
