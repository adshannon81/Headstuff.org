					...
					<div class="widget_social">
						<div class="social with_color">
							...
							<?php if ( get_the_author_meta( 'googleplus', $userid ) ) : ?>
								<a rel="author" itemprop=”author“ href="<?php the_author_meta( 'googleplus', $userid ); ?>" class="toptip" title="<?php echo $curauth->display_name; ?> <?php _e('on Google+', 'T20'); ?>" target="_blank"><i class="fa fa-google-plus"></i></a>
							<?php endif ?>
