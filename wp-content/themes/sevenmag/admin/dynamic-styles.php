...
.search_icon i:hover, .wp-pagenavi a, #footer #submit, #footer .search_btn, #footer .wpcf7-submit, .readmore:hover, .woocommerce-pagination a, #layout .sf-menu li li b { background-color: '.ot_get_option('theme_color').' !important; }
