...
$page_slideshow = array(
	...
	'fields'      => array(
		array(
			...
			'label'		=> __('Slideshow Posts', 'T20'),
			'desc'		=> __('By not selecting a category, it will show your latest post(s) from all categories', 'T20'),
			'type'		=> 'category-select'
		),
		array(
			'id'		=> '_slideshow_num',
			'label'		=> __('Slideshow Numbers of slides', 'T20'),
		...
		array(
			...
			'label'		=> __('Slideshow Numbers of slides in view', 'T20'),
			'desc'		=> __('Number of posts in one slide', 'T20'),
			'std'		=> '5',
			'type'		=> 'numeric-slider',
			'min_max_step'	=> '1,5,1'
		),
