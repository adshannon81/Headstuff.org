...
// VC functios
	require_once('T20_m.php');
	require_once('T20_b1.php');
	require_once('T20_b2.php');
	require_once('T20_b3.php');
	require_once('T20_b4.php');
	require_once('T20_b5_slider.php');
	require_once('T20_b7_slider2.php');
	require_once('T20_b6.php');
	require_once('T20_b8.php');
	require_once('T20_b9.php');
