...
<div class="main-container author-page"><!--container-->
            ...
            <div class="full-main-content" role="main" itemscope itemtype="http://schema.org/Person">
		        <!--Main Content-->
				<div class="author-cover" style="<?php if(get_the_author_meta( 'user_meta_image' ) != '') { ?>background:url(<?php the_author_meta( 'user_meta_image' ) ?>) no-repeat center;<?php } else { ?>background:url(<?php echo mom_option('custom_author_cover', 'url'); ?>) no-repeat center;<?php } ?>">
