            ...
            <div class="footer-menu clearfix">
                <div class="inner">
	                ...
	                wp_nav_menu( array('theme_location' => 'footer', 'walker' => new mom_custom_Walker(), 'container' => 'ul', 'menu_class' => 'footer_mega_menu'));
                    ...
                    <div class="alignleft">
                        ...
                        <div class="footer-logo">
                            ...
                            <?php if(mom_option('foot_retina_logo','url') != '') { ?>
                                <img itemprop="logo" src="<?php echo mom_option('foot_retina_logo','url'); ?>" width="<?php echo mom_option('foote_retina_logo_size','width'); ?>" height="<?php echo mom_option('foote_retina_logo_size','height'); ?>" alt="<?php bloginfo('name'); ?>">
                                <?php } else { ?>
                                <img itemprop="logo" src="<?php echo mom_option('foot_logo','url'); ?>" alt="<?php bloginfo('name'); ?>">
                            <?php } ?>
                            </a>
                        </div>
                        <?php } ?>
