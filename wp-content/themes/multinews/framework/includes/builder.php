...
vc_map( array(
    ...
    "params" => array(
      array(
         ...
         "param_name" => "type",
         "value" => array(
			'Slider 1 (Default)' => 'def',
			'Slider 2 (Full width slider)' => 'slider2',
			),
      ),
      array(
         "type" => "dropdown",
      ...
      array(
         ...
         "heading" => __("Number of posts", 'framework'),
         "param_name" => "number_of_posts",
         "dependency" => Array('element' => "type", 'value' => array('def', 'video')),
      ...
      array(
         ...
         "param_name" => "timeout",
         "dependency" => Array('element' => "type", 'value' => array('def')),
         "description" => __('the time between each slide with ms, default : 5000', 'framework')
      ),
      array(
         "type" => "checkbox",
         "class" => "",
