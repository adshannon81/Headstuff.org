...
*/
        ...
        ?>
			<div class="video_frame">
	         	<iframe width="100%" height="<?php echo $vi_height; ?>" src="http://www.youtube.com/embed/<?php echo $video_id; ?>" frameborder="0" allowfullscreen></iframe>
	        </div>
	        
		<?php } elseif ($video_type == 'facebook') { ?>
			<div class="video_frame">
			    <iframe src="http://www.facebook.com/video/embed?video_id=<?php echo $video_id; ?>" width="100%" height="<?php echo $vi_height; ?>" frameborder="0"></iframe>
			</div><!--End Vido_frame-->
        <?php } elseif ($video_type == 'vimeo') { ?>
	        <div class="video_frame">
	         	<iframe src="//player.vimeo.com/video/<?php echo $video_id; ?>?title=0&amp;byline=0&amp;portrait=0&amp;color=ffffff" width="100%" height="<?php echo $vi_height; ?>" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
	        </div>
        <?php } elseif ($video_type == 'daily') { ?>
        	<div class="video_frame">
        		<iframe frameborder="0" width="100%" height="<?php echo $vi_height; ?>" src="http://www.dailymotion.com/embed/video/<?php echo $video_id ?>?logo=0"></iframe>
        	</div>
		...
		<div class="postformat-gallery">
			...
			<?php 
				...
				foreach($slides as $slide) {
					...
					$img = wp_get_attachment_image_src($imgid, 'big-thumb-hd');
					$img = $img[0];
	        ...
	        jQuery(document).ready(function($) {
	          ...
	          $('.postformat-gallery-wrap').owlCarousel({
				...
				$(".postformat-gallery-item a").prettyPhoto();
	        });
			</script>
