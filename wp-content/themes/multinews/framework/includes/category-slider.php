...
<section class="section clearfix">
    <div class="cat-slider">
    	...
    	<div id="bb-bookblock" class="bb-bookblock"><!-- bookblock -->
    		<div class="bb-item">
				...
				<div class="cat-slider-wrap">
		            ...
		            $query = new WP_Query( array( 'cat' => $category_id, 'posts_per_page' => $count , 'orderby' => $cat_slider_by, 'no_found_rows' => true, 'cache_results' => false ) );
				...
				<?php
				    ...
				    ?>
		                	<img itemprop="image" src="<?php echo mom_post_image($thumb_size); ?>" alt="<?php the_title(); ?>">
		                </a>
    		...
    		<div class="bb-item">
				<div class="cat-slider-mpop">
					...
					$query = new WP_Query( array( 'cat' => $category, 'posts_per_page' => 2, 'orderby' => 'comment_count', 'no_found_rows' => true, 'cache_results' => false ) );
					if ( $query->have_posts() ) : while ( $query->have_posts() ) : $query->the_post(); 
					?>
					...
					<ul>
						...
						$query = new WP_Query( array( 'cat' => $categoryid, 'posts_per_page' => 4, 'offset' => 2, 'orderby' => 'comment_count', 'no_found_rows' => true, 'cache_results' => false ) );
						if ( $query->have_posts() ) : while ( $query->have_posts() ) : $query->the_post(); 
						?>
						<li>
							<?php if( mom_post_image() != false ) { ?>
							<figure class="post-thumbnail"><a href="<?php the_permalink(); ?>">
		                    	<img itemprop="image" src="<?php echo mom_post_image('postlist-thumb'); ?>" data-hidpi="<?php echo mom_post_image('big-thumb-hd'); ?>" alt="<?php the_title(); ?>">
			                </a></figure>
			                <?php } ?>
							<div class="f-p-title">
			                    <h2 itemprop="name"><a itemprop="url" href="<?php the_permalink(); ?>"><?php the_title(); ?></a></h2>
        ...
        <div class="cat-slider-nav">
            ...
            <ul>    
                <?php
		            $query = new WP_Query( array( 'posts_per_page' => $count,'post__in' => $db_posts, 'orderby' => 'post__in', 'no_found_rows' => true, 'cache_results' => false ) );
				if ( $query->have_posts() ) : while ( $query->have_posts() ) : $query->the_post();
                ?>
