        ...
        public function render() {
            ...
            if (isset($this->value) && is_array($this->value)) {
                ...
                echo '<a class="button select_icon mom_select_icon_sicon" data-id="' . $this->field['id'] . '" data-x="'. $x . '" title="Select Icon">' . __('Select Icon', 'redux-framework') . '</a> <span class="bt-sep">OR</span>';
                    echo '<input type="text" id="' . $this->field['id'] . '-customicon_' . $x . '" name="' . $this->field['name'] . '[' . $x . '][customicon]" value="' . esc_attr($icon['customicon']) . '" class="full-text" placeholder="Insert icon URL" />';
                echo '</div>';
                    ...
                    echo '<li><label>Background Color on hover: </label><br><input type="text" id="' . $this->field['id'] . '-bgcolorh_' . $x . '" name="' . $this->field['name'] . '[' . $x . '][bgcolorh]" value="' . esc_attr($icon['bgcolorh']) . '" class="redux-color redux-color-init  wp-color-picker" placeholder="Insert color" /></li>';
