                            ...
                            <div class="weather-widget">
                                <div class="first-weather">
                                    <div class="weather-data">
                                        <h2><?php if ($display != ''){ echo $display; } else { echo $city; } ?></h2>
                                        <time class="weather-date"><span><?php _e('Today', 'framework'); ?></span><?php echo $this_day; ?></time>
                                    </div>
...
?>
                                <div class="w-item-wrap w-item-closed">
                                    <h4 class="w-item-title">
                                        ...
                                        <time><?php echo $date->format($date_format); ?></time>
                    ...
                    <span class="not-valid-city <?php echo $val_class; ?>"><?php _e('Not found', 'framework'); ?><i class="brankic-icon-error"></i></span>
                     <div class="today-weather-box">
                        <div class="t-w-title">
                                ...
                                <time class="weather-date"><span></span><?php echo $this_day; ?></time>
                        </div>
...
?>
                     <li>
                                <div class="t-w-title">
                                        ...
                                        <time class="weather-date"><?php echo $date->format($date_format); ?></time>
                                </div>
                                <div class="weather-results">
