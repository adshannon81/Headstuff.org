...
<img src="<?php echo mom_post_image('media1-thumb'); ?>" data-hidpi="<?php echo mom_post_image('big-thumb-hd'); ?>" alt="<?php the_title(); ?>">
</a>
...
<figure class="post-thumbnail">
<a href="<?php the_permalink(); ?>">
<img src="<?php echo mom_post_image('media-thumb'); ?>" data-hidpi="<?php echo mom_post_image('big-thumb-hd'); ?>" alt="<?php the_title(); ?>">
</a>
<div class="media-data">
<div class="media-format"></div>
<?php if ($post_format == ('video')) { ?>
