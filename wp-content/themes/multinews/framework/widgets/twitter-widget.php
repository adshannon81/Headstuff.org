...
class mom_widget_twitter extends WP_Widget {
	function mom_widget_twitter() {
		...
		$this->WP_Widget('momizatTwitter',__('Momizat - Twitter','framework'),$widget_ops);
				...
				?>
					...
					<?php echo $txt; ?>
                                   ...
                                   <ul class="twiter-buttons">
                                        <li class="replay"><a href="<?php echo esc_url( 'https://twitter.com/intent/tweet?in_reply_to=' . $tweet_id ); ?>" onclick="window.open(this.href, '', 'menubar=no,toolbar=no,resizable=no,scrollbars=no,height=455,width=600');return false"><?php _e('Replay', 'framework'); ?></a></li>
