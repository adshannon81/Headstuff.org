...
class mom_widget_slider extends WP_Widget {
	function mom_widget_slider() {
		...
		$this->WP_Widget('momizat-slider',__('Momizat - slider','framework'),$widget_ops);
	...
	function widget( $args, $instance ) {
		...
		$animationin = $instance['animationin'];
		$animationout = $instance['animationout'];
        ...
        <div class="slider-widget-item" itemscope="" itemtype="http://schema.org/Article">
            <figure class="post-thumbnail">
                <a itemprop="url" href="<?php the_permalink(); ?>" rel="bookmark">
                    <img itemprop="image" src="<?php echo mom_post_image('sliderwidget-thumb'); ?>" data-hidpi="<?php echo mom_post_image('catslider1-thumb'); ?>" alt="<?php the_title(); ?>">
                </a>
            </figure>
