	...
	jQuery(function($){
		...
		var form = jQuery('<div id="images-form">\
			...
			<div class="mom_tiny_input">\
				...
				<div class="mom_color"><span>Carousel Title</span><input id="images-title" value="" type="text" class="custom_input_big" /></div>\
				<div class="mom_color"><span>Carousel Effect</span><select id="images-carousel_effect">\
				...
				<div class="mom_color"><label for="images-auto_slide">Auto Slideshow</label><input id="images-auto_slide" type="checkbox"></div>\
