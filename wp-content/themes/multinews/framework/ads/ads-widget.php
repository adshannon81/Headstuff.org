...
class mom_ads_widget extends WP_Widget {
	function mom_ads_widget() {
		...
		$widget_ops = array('classname' => 'momizat-ads','description' => __('Widget display any type of ads','framework'));
		$this->WP_Widget('momizatAds',__('Momizat - Ads','framework'),$widget_ops);
...
<select id="<?php echo $this->get_field_id( 'ad' ); ?>" name="<?php echo $this->get_field_name( 'ad' ); ?>" class="widefat">
	...
	?>
		...
		<p>
			...
			<label for="<?php echo $this->get_field_id( 'tr' ); ?>"><?php _e('Transparent background', 'framework'); ?></label>
		</p>
<?php 
}
	} //end class